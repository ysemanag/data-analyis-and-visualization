...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/yves_semg/Desktop/cpsc415/project1/project_data/flask'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/yves_semg/Desktop/cpsc415/project1/project_data/flask/bin/deactivate.nu'
