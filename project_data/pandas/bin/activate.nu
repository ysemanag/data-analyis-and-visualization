...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/yves_semg/Desktop/cpsc415/project1/project_data/pandas'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/yves_semg/Desktop/cpsc415/project1/project_data/pandas/bin/deactivate.nu'
